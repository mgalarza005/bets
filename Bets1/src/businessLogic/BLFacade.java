...
public interface BLFacade  {
	...
	@WebMethod Vector<Kuota> kuotakLortu(Question g);


	@WebMethod User lortuUser(String usr);


	@WebMethod void apustuaAnitzaGorde(String usr, double d, Vector<Apustua> apustuLista);


	@WebMethod void mugimenduaErabiltzaileariGehituApustuAnitza(String usr, double d, Vector<Apustua> apustuLista);


	@WebMethod void ApustuaKuotanGehitu(String usr, Kuota k, Apustua a1);
