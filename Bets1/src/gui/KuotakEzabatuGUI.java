...
public class KuotakEzabatuGUI extends JFrame {
	...
	private final JLabel mezualabel = new JLabel(ResourceBundle.getBundle("Etiquetas").getString("KuotakEzabatuGUI.lblNewLabel.text")); //$NON-NLS-1$ //$NON-NLS-2$
...
this.getContentPane().add(scrollPaneEvents, null);
		...
		JButton btnKuotakIkusi = new JButton(ResourceBundle.getBundle("Etiquetas").getString("KuotakEzabatuGUI.btnKuotakIkusi.text")); //$NON-NLS-1$ //$NON-NLS-2$
