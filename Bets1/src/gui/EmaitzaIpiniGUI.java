...
public class EmaitzaIpiniGUI extends JFrame {
	...
	private JButton emiatzaGorde = new JButton();
	// Code for JCalendar
	...
	private void jbInit() throws Exception
	{
		...
		scrollPaneQueries.setBounds(new Rectangle(138, 247, 406, 83));
...
this.getContentPane().add(scrollPaneEvents, null);
		...
		emiatzaGorde.setText("Emaitza ipini");
		
		emiatzaGorde.setBounds(new Rectangle(311, 510, 130, 30));
		getContentPane().add(emiatzaGorde);
		emiatzaGorde.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					if(emaitza.getText().isEmpty()) errorea.setText("Emaitza bat sartu");
						...
						negozioLogika.emaitzaIpini(emaitza.getText(),g);
						Kuota k = negozioLogika.lortuKuotaIrabzalea(g);
						
						if(k!=null) {
							negozioLogika.kalkulatuDirua(k,g);
						}else {
							errorea.setText("Zerbait txarto joan da.");
						}
						errorea.setText("Emaitza jarri da");
						emaitza.setText("");
